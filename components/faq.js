...
const faqdata = [
  ...
  },
  {
    ...
    answer:
      "Да. Главное предупредите нас за 6 часов до урока. Если преподаватель пришел на урок, а студента нет и нас не предупредили, то я грущу, звоню родителям и засчитываю занятие как проведенное.",
  },
  {
